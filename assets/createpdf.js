...
export const printPdf = (params) => {
  ...
  pdfDoc.text(
    `${params.viewMonth.toLocaleDateString(
      "hu-HU",
      date.dateYearAndMonthViev
    )}`,
    105,
    20,
    "center"
  ...
  pdfDoc.text(`${params.legal}`, 15, 30, {
    maxWidth: 190,
    align: "left",
  });
  ...
  pdfDoc.text(
    `lakcím: ${params.basedatas.city}, ${params.basedatas.address}`,
    105,
    40
  );
  // car & car plate
  ...
  pdfDoc.autoTable({
    ...
    foot: [
      [
        ...
        `összesen:`,
        ``,
        `${params.sumTotal.toLocaleString("hu-HU", {
          style: "currency",
          currency: "HUF",
        })}`,
      ],
  ...
  // Add  metadatas/properties to the pdf Document.
  pdfDoc.setProperties({
    title: `${params.pdfName}`,
    subject: `Munkába járás elszámolása`,
    author: `${params.basedatas.name}`,
    keywords: `útiköltség, elszámolás`,
    creator: `Generated by Accounting for going to work, created by Roland Hetesi, © 2023`,
  });
